...
function HomeFooter({ theme = "light", className }: HomeFooterProps) {
  return (
    <footer
      className={cn(
        "absolute z-25 px-4 sm:px-8 custom-md:px-16 custom-lg:px-32 xl:px-48 text-xs sm:text-sm tracking-widest py-4 md:py-6 bottom-0 w-full border-t border-solid",
        className,
        theme === "light"
