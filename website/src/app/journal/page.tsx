...
function JournalPage() {
  ...
  return (
    <>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 gap-y-12 sm:gap-y-16 lg:gap-y-24 text-gray-700 items-stretch">
            ...
            <div className="overflow-hidden mb-4 sm:mb-5 lg:mb-6">
              <Link href={`/journal/${item.slug}`}>
                <Image
                  ...
                  width={600}
                  height={600}
                  className="aspect-[3/3.9] object-cover w-full transition-all duration-700 ease-out group-hover:scale-110 group-hover:brightness-95"
