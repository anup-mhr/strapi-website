  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="py-12 padding">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-flow-col gap-8 gap-y-16 text-gray-600 mt-18 mb-12">
          <div>
            <h4 className="font-bold mb-4 text-black uppercase">FIND US</h4>
            <div className="space-y-2 uppercase text-sm">
              <p>HEIRLOOM NAGA, HUSSAIN BUILDING</p>
              <p>CIRCULAR ROAD, DIMAPUR</p>
              <p>NAGALAND 797112</p>
            </div>
            <h4 className="font-bold mt-10 mb-4 text-black uppercase">
              TIMINGS
            </h4>
            <div className="space-y-2 uppercase text-sm">
          ...
          <div>
            <h4 className="font-bold mb-4 text-black uppercase">EMAIL</h4>
            <div className="space-y-2 uppercase text-sm">
              <p>HEIRLOOMNAGA@GMAIL.COM</p>
              <p>INFO.HEIRLOOMNAGA@GMAIL.COM</p>
              <p>JESMINAZELIANG@GMAIL.COM</p>
            </div>
            <h4 className="font-bold mt-10 mb-4 text-black v">CALL</h4>
            <div className="space-y-2 uppercase text-sm">
              <p>+91 94360-03336</p>
              <p>+91 70027-27722</p>
            </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <a href="https://heirloomnagacentre.com" target="_blank">
        ...
        <div className="w-full h-96 md:h-[40rem] mb-18">
          <iframe
