    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="padding py-8 sm:py-10 md:py-12">
                <Heading title="" subtitle="Terms & Conditions" />
                <div className="w-full mx-auto max-w-5xl">
                    <section className="mb-6">
                        <h2 className="font-semibold mb-2">OVERVIEW</h2>
                        <p className="mb-4">
                           Heirloom Naga offers this website, including all information, tools and
                    ...
                    <section className="mb-6">
                        ...
                        <p className="mb-4">
                            In no case shall www.heirloomnaga.com, our directors, officers, employees,
                    ...
                    <section className="mb-6">
                        ...
                        <p className="mb-4">
                            You agree to indemnify, defend and hold harmless www.heirloomnaga.com and our
