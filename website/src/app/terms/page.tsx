      ...
      <div className="padding py-8 sm:py-10 md:py-12">
        ...
        <div className="w-full mx-auto max-w-5xl">
          <section className="mb-6">
            ...
            <p className="mb-4">
              Heirloom Naga offers this website, including all information,
          ...
          <section className="mb-6">
            ...
            <p className="mb-4">
              In no case shall www.heirloomnaga.com, our directors, officers,
          ...
          <section className="mb-6">
            ...
            <p className="mb-4">
              ...
              www.heirloomnaga.com and our parent, subsidiaries, affiliates,
