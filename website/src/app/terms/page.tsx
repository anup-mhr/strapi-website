    ...
    <div className="bg-white text-black font-dosis tracking-wider">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 custom-md:px-16 custom-lg:px-32 xl:px-44 py-20 md:py-40 ">
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">
            This website is operated by Aku Zeliang. Throughout the site, the
            terms &quot;w &quot;, &quot;us&quot;, and &quot;our&quot; refer to
            Aku Zeliang. Aku Zeliang offers this website, including all
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">
            Certain products or services may have limited quantities available
            online through the website. Those products or services may have
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">
            In no case shall Aku Zeliang, our directors, officers, employees,
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">
            You agree to indemnify, defend and hold harmless Aku Zeliang and our
        ...
        <section className="mb-6">
          ...
          <p className="mb-4">
            ...
            <a href="mailto:hello@akuzeliang.com">hello@akuzeliang.com</a>.
          </p>
        </section>
      </div>
