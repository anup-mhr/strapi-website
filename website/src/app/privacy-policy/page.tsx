    ...
    <div className="min-h-screen">
      ...
      <div className="padding py-8 sm:py-10 md:py-12">
        ...
        <div className="w-full mx-auto max-w-5xl">
          ...
          <p className="mb-4">
            Heirloomnaga.com <strong>DOES NOT</strong> trade or sell personal
            information in any manner except as specified herein, or if
            consented by you. Any personal information submitted through the
            website and information collected will be solely used:
          </p>
